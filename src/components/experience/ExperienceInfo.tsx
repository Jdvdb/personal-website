...
const ExperienceInfo = ({ activeButton }: ExperienceInfoProps) => {
  ...
  const copyArrayOne = [
    ...
    "Metro Continuing Education is a part of Edmonton Public Schools and looks to provide additional learning opportunities to people of all ages. Following my high school graduation, my first job related to coding was as a summer camp instructor with Metro for elementary students.",
  ];
  const copyArrayTwo = [
    ...
    "I taught 2 different programs: one was about creating basic games with javascript and another was using lua to create worlds in Roblox. This opportunity was a great way to get my foot in the door as a developer and introduce the world of computing science to prospective future developers!",
  ];
  return (
