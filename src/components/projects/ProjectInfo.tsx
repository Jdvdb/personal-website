...
const ProjectInfo = ({ projectNumber }: ProjectInfoProps) => {
  ...
  const projectMemo = [
    ...
    "SONiC 102.9 is a radio station that plays lots of music I enjoy, and a lot of ads I don't. To get around this, I wrote a simple Go script using the spotify API and web player for the radio station. I built the script in a docker image and then ran that on a raspberry pi in my basement for a few weeks to create a playlist that offered an ad free listening experience.",
    "As my first year of university came to a close, a pandemic swept the nation and left me unsure of what a summer internship would look like. Since I thought this would be a temporary situation, I spent my summer in the Startup Edmonton Preflight program to learn about creating a Startup. I worked with a high school friend on a product called 'WeNote', a note sharing system designed for students. While the actual development was a basic landing page and a simple prototype, I learned about solution-oriented design and how to ask clients what they really want.",
    "As a final project for my intro computing science course, I was given an open ended assignment to create whatever I wanted with C++, Python, and/or Arduino's. I saw this as a great opportunity to apply some of the concepts I was learning in an intro to AI course and I decided to build a Monte Carlo Tree Search algorithm for a connect four agent. Since I used C++, I had to implement all the steps for the algorithm within my own version of a connect four game. I ended up with an AI that could sometimes beat me and my friends at the game that ran in a terminal or on an Arduino with a touch screen.",
  ];
  const projectRepos = [
